            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <?PHP
                     ...
                     <td><a href="<?PHP $_SERVER['DOCUMENT_ROOT']?>/Desbloqueo/laptab/codigos_laptab.php?clavecct=<?PHP echo $row_esc['clavecct']?>"><?PHP echo $i;?></a></td>
                    ...
                    <a href="<?PHP $_SERVER['DOCUMENT_ROOT']?>/Desbloqueo/busquedaAvanzada.php" class="btn btn-primary">Nueva Busqueda</a>
                    </div>
